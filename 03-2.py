...
def combination(n, r):
    r_under= math.factorial(r)
    n_upper= math.factorial(n)//math.factorial(n-r)
    return n_upper//r_under 
     ##Calcurate and return combination _n C_r ##
...
def drawRationalBezier(cp, w, N):
    ...
    for t in np.linspace(0, 1, N):
        ...
        glVertex2f(c[0]/sum_weight, c[1]/sum_weight)
        ## Specifying a vertex ##
    glEnd()
