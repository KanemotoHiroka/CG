...
def alignment_rule(bird_index, visible_list):
    ...
    vec_alignment = (average_vel) / np.linalg.norm(average_vel) if np.linalg.norm(average_vel)  != 0 else average_vel 
    ##vec_alignment = (average_vel-bird[bird_index].vel) / np.linalg.norm(average_vel-bird[bird_index].vel) if np.linalg.norm(average_vel)  != 0 else average_vel  ## calculate vec_alignment ##
